...
def evolutionary_algorithm(obj_function, dimension, rand_seed):
...
class Evolutionary:
    ...
    def evolutionary_alg(self, fun_q, P_pop, pop_size, sigma, elite_num):
        # print("INIT X: ", best_individual[0])
        tmax = 100000000000000000000000000000000000000000000/pop_size
        t = 0
        eval = []
        for coord in P_pop:
